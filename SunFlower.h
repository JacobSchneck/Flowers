...
class SunFlower : public Flower {
    ...
    public: 
        // Constructors
        SunFlower();
        SunFlower(color color_pistal, color color_petal, color color_second_petal, point2D center_pistal, int radius_pistal);
        ...
        void setColorSecondPetal(color color_petal);
